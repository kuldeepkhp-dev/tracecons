<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DefaultExp.aspx.cs" Inherits="_Default" Title="Exporter Module" %>
   ...
   <BLINK><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: medium; BACKGROUND: #ff8000">About this service </SPAN></BLINK>
        ...
        <tr>
            ...
            <asp:AsyncPostBackTrigger controlid="btn_Refereshcaptch" eventname="Click" />
                ...
                <asp:Label ID="lblPwd" runat="server" ForeColor="Red"></asp:Label></td>
        </tr>
         <tr>
