<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayYes.aspx.cs" Inherits="Payment_PayYes"   MaintainScrollPositionOnPostback="false"
...
<center>
	...
	<form  method="post" action="PostYes.aspx" name="frmTransaction" id="frmTransaction" runat="server" >  
	...
	<tr>
        ...
        <td  align="left" width="50%"> <input runat="server" id="account_id" name="account_id" type="text" value="PERP00176"/><br><span><font color="red"> Please Enter your Account ID provided.</font></span> </td> 
    </tr>
    <tr>
        <td class="fieldName" width="50%"><span class="error">*</span> Secret Key</td>
        <td  align="left" width="50%"> <input runat="server" id="secretkey" name="secretkey" type="text" value="VYGV4DFZIRH5PDQX" size="35"/><br><span><font color="red"> Please Enter your Secret Key provided.</font></span></td>
    </tr>
	<tr>
